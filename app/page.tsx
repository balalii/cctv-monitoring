...
// Animasi transisi halaman utama, durasi sedikit diperpanjang
const pageTransitionVariants = {
  ...
  animate: {
    ...
    filter: 'blur(0px)',
    transition: {
      duration: 0.5, // Sedikit lebih lama untuk transisi yang lebih halus
      ease: [0.25, 1, 0.5, 1],
    },
  },
  exit: {
...
// Animasi kartu konten, delay diatur untuk efek cascade yang lebih jelas
const cardVariants = {
  hidden: {
    opacity: 0,
    y: 70, // Mulai dari posisi y yang lebih rendah
    scale: 0.9,
    rotateX: 10,
  },
  visible: (index: number) => ({
    ...
    rotateX: 0,
    transition: {
      delay: 0.6 + index * 0.1, // Delay awal + delay bertingkat untuk efek cascade
      duration: 0.8,
      ease: [0.16, 1, 0.3, 1],
      type: 'spring',
      stiffness: 100,
...
// Animasi header, ditambahkan delayChildren agar animasi anak dimulai setelahnya
const headerVariants = {
  ...
  visible: {
    ...
    transition: {
      ...
      ease: [0.16, 1, 0.3, 1],
      staggerChildren: 0.1,
      delayChildren: 0.2, // Menunda animasi elemen anak (judul, statistik)
    },
  },
};

// Animasi bar pencarian, delay ditambah agar muncul setelah header
const searchVariants = {
  ...
  visible: {
    ...
    transition: {
      duration: 0.7,
      ease: [0.16, 1, 0.3, 1],
      delay: 0.4, // Delay lebih lama agar muncul setelah header
    },
  },
};
